...
public class SpringIntegrationTransformFilterigHeaderApplication implements ApplicationRunner {

	@Autowired
	private PrinterGateway gateway;

	public static void main(String[] args) {
		SpringApplication.run(SpringIntegrationTransformFilterigHeaderApplication.class, args);
	}
