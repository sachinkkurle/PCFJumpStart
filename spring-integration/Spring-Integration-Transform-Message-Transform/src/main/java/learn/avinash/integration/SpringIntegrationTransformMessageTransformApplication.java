...
public class SpringIntegrationTransformMessageTransformApplication implements ApplicationRunner {

	@Autowired
	private PrinterGateway gateway;

	public static void main(String[] args) {
		SpringApplication.run(SpringIntegrationTransformMessageTransformApplication.class, args);
	}
