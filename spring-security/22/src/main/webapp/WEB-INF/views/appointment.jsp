...
<body>
	...
	<div class="container">
		...
		<ul class="list-group">
			<li class="list-group-item"><label>Customer:</label><span>${appointment.user.firstName }
					${appointment.user.lastName}</span></li>
			...
			<li class="list-group-item"><label>Services:</label>
				<ul>
			...
			<li class="list-group-item"><a class="btn btn-default"
				...
				<sec:authorize url="/schedule/*">
					<a class="btn btn-default"
						href="<spring:url value="/appointments/complete"/>" role="button">Mark
						Complete</a>
				</sec:authorize></li>
		</ul>
	</div>
